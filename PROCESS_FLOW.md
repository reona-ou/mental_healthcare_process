...
|---|---|---|---|
| -1 | 37 | - | 短文 + 統計異常 |
| 0 | 26 | 離婚, 浮気, 考える, 変わる | 離婚・浮気 |
| 1 | 26 | 貰う, 両親, 一緒, 連絡 | 人間関係・支援 |
| 2 | 20 | 苦手, 欲しい, 相談出来る | 相談・苦手 |
| 3 | 20 | おっぱい, 眠る, 寝る | 産後・授乳 |
| 4 | 19 | 育児, 地域, 保健 | 育児支援・地域 |
| 5 | 18 | 流産, 妊娠, 辛い | 流産・妊娠 |
| 6 | 16 | しんどい, 駄目, 可愛い | 育児ストレス |
...
| カテゴリ | 内容 | 件数 | 割合 |
|---|---|---|---|
| category 0 | 負面（離婚・浮気・流産・詐欺・DV・自殺） | 62 | 34.1% |
| category 1 | 非負面（育児相談・日常ストレス等） | 120 | 65.9% |
